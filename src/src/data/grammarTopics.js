...
**ชีวิตประจำวัน:**
→ **Tee ziehen lassen** = แช่ชาให้ได้ที่ / ปล่อยให้สิ่งต่างๆ ดำเนินไปตามธรรมชาติ อย่าเร่ง
...
**สุดฮา / ไม่น่าเชื่อ:**
→ **Ich glaube, mein Schwein pfeift!** = ฉันตกใจมาก / ไม่น่าเชื่อเลย!
   (ตรงตัว: ฉันคิดว่าหมูของฉันกำลังผิวปาก)

→ **Alles hat ein Ende, nur die Wurst hat zwei.** = ทุกอย่างต้องจบสิ้น
   (ตรงตัว: ทุกอย่างมีจุดสิ้นสุดหนึ่งด้าน มีแต่ไส้กรอกที่มีสองด้าน)
